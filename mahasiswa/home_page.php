...
<script>
            ...
            event.preventDefault(); // Mencegah tautan default dilakukan
            
            if (confirm("Apakah Anda yakin akan logout?")) {
                window.location.href = "logout.php"; // Redirect ke skrip logout setelah konfirmasi
            }
        }
    </script>
...
<body>
    <div class="container">
        <div id="page-h" class="page-header">
            <div class="page-logo">
                <img src="../assets/image/stmik.png" class="logo" />
            </div>
        ...
        <div class="page-content">
            <div class="content-header">
                ...
                <div>
                    <a class="link" href="logout.php" onclick="confirmLogout(event)">
